...
public class TestGameBoard {
     ...
     */
    @Test
    public void testCheckHorizWin_top_right_true() {
        // Board constructor variables
        int numRows = 5;
        int numCols = 5;
        int numToWin = 4;
    ...
    public void testDropToken_ValidEmptyColumn() {
        ...
        expectedBoard = addToBoardArray(expectedBoard, 0, 'x');
    ...
    public void testDropToken_ValidNonEmptyColumn() {
        ...
        expectedBoard = addToBoardArray(expectedBoard, 3, 'x');
        actualBoard.dropToken('o', 3);
        expectedBoard = addToBoardArray(expectedBoard, 3, 'o');
    ...
    public void testDropToken_top_right() {
        ...
        for (int i = 0; i < numRows - 1; i++) {
            ...
            expectedBoard = addToBoardArray(expectedBoard, 4, 'x');
        }

        // Drops a token in the final spot in the column
        actualBoard.dropToken('o', 4);
        expectedBoard = addToBoardArray(expectedBoard, 4, 'o');
